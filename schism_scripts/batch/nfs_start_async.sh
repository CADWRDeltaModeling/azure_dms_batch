...
nfs_share=${2-/mnt/resource/nfs} # NFS_MOUNT_POINT from nfs_common_async.sh 
...
if [[ $AZ_BATCH_IS_CURRENT_NODE_MASTER == "true" ]]; then
    ...
    source /opt/schism_scripts/batch/nfs_common_async.sh
...
# NFS mount options
#nfs_mount_options="rw,rsize=131072,wsize=131072,noacl,nocto,noatime,nodiratime"
nfs_mount_options="rw,async,rsize=65536,wsize=65536,noatime,nodiratime,relatime"
#nfs_mount_options="rw,noatime,nodiratime"
