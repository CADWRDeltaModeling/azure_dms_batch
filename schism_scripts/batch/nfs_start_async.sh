...
# NFS mount options
#nfs_mount_options="rw,async,rsize=131072,wsize=131072,noacl,nocto,noatime,nodiratime"
nfs_mount_options="rw,async,rsize=65536,wsize=65536,noatime,nodiratime"
